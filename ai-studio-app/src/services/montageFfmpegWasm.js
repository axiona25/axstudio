 ...
 *
 * @param {{ videoUrl: string, audioUrl: string, onProgress?: (msg: string) => void }} params
 ...
 * @returns {Promise<{ blob: Blob, renderModeUsed: string, segmentResults: object[], concatHadToReencode: boolean }>}
 */
export async function renderMontageWithFfmpegWasm(params, onProgress) {
  ...
  return { blob, renderModeUsed, segmentResults, concatHadToReencode };
}
