...
class FaceProcessorPro:
    ...
    def _init_parsing_net(self):
        ...
        try:
            ...
            self._debug_log.append(f"PARSING_NET_FAILED: {e}")
            self.parsing_net = None
    ...
    def process(
        ...
        try:
            self._debug_log = []
            self._debug_log.append(f"parsing_net_loaded: {self.parsing_net is not None}")
            ...
            return {
                "output": {
                    ...
                    "parsing_net_loaded": self.parsing_net is not None,
